...
resource externalNetwork 'Microsoft.ManagedNetworkFabric/l3IsolationDomains/externalNetworks@2023-02-01-preview' = {
  ...
  properties: {
    ...
    optionBProperties: optionBProperties != {} ? {
      importRouteTargets: contains(optionBProperties, 'importRouteTargets') ? optionBProperties.importRouteTargets : null
      exportRouteTargets: contains(optionBProperties, 'exportRouteTargets') ? optionBProperties.exportRouteTargets : null
    } : null
